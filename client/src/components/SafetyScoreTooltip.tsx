    ...
    <div className="relative inline-block">
      ...
      {isOpen && (
        <div className="absolute z-50 w-80 p-4 bg-gray-800 border border-gray-600 rounded-lg shadow-lg text-sm left-0 top-6">
          <div className="font-semibold mb-2 text-[#EAEAEA]">Safety Score Formula</div>
          <div className="text-xs text-[#B5B5B5] mb-3 font-mono bg-gray-900 p-2 rounded">
          ...
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              ...
              <span className="text-[#EAEAEA]">{breakdown.base_score.toFixed(1)}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="border-t border-gray-700 mt-2 pt-2 flex justify-between font-semibold">
              <span className="text-[#EAEAEA]">Final Score:</span>
              <span className="text-[#EAEAEA]">{score.toFixed(1)}</span>
            </div>
          </div>
        </div>
      )}
